...
p_training="-force $p_trg_factors $p_letrac $p_manual_align $p_kb $p_verbose $p_xeval $p_pialign $p_del_file $p_3_sync $p_additional_rule $p_shuffle $p_compose_size"

# 3 Sync Training-flag
#p_3_keyword="fold-baseline/normal-keyword"
#p_3_question="fold-baseline/normal"
#p_3_training="$p_letrac $p_kb $p_xeval $p_del_file $p_additional_rule $p_trg_factors -force"

# Tune-flag
p_database="-database-config config/mysql.config"
p_driver="-driver-function $driver"
p_tune="-force $p_travatar $p_trg_factors $p_geoquery $p_threads $p_database $p_nbest $p_letrac $p_driver $p_time $p_notypecheck $p_empty $p_lamtram"
